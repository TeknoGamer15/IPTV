...
try:
    ...
    fetch_and_save_m3u8(ntv_base_url, ntv_modified_url, "Listeler/Kanallar/ntv.m3u8")

    # Fetch and save STAR m3u8 file
    fetch_and_save_m3u8(star_base_url, star_modified_url, "Listeler/Kanallar/startv.m3u8")
